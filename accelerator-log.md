...
```json
{
  "applicationName" : "dotnetapp14",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=kadourah&repo=dotnetapp14",
  "projectName" : "donet-app-14"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'dotnetapp14'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->dotnetapp14]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'dotnetapp14.csproj'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->donet-app-14]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=kadourah&repo=dotnetapp14'
